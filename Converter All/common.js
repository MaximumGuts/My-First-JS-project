...
{
    let allErrorBorder = document.getElementsByClassName('.tool-error-border');
    console.log(allErrorBorder.length)
	let allErrorMessage = document.getElementsByClassName('tool-error-message');
	let i;
    // remove border
...
function _cmnShowAllErrorMessage(fieldID,errorMessage){
...
function _cmnHideElement(elementID){
    let selectedDisplayValue = document.getElementById(elementID).style.display;
...
function updateLayOut(){
    _cmnHideElement("Age");
    _cmnHideElement("Length");
    _cmnHideElement("Currency");
    const selectedTool = document.getElementById("Tool-Select").value;
    console.log(selectedTool)
    _cmnShowElement(selectedTool,"block");
}
